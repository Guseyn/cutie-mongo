module.exports = {
  ...
  ArrayOfServers: require('./src/repl-set/ArrayOfServers'),
  CreatedReplSet: require('./src/repl-set/CreatedReplSet'),
  ReplSetWithCloseEvent: require('./src/repl-set/ReplSetWithCloseEvent'),
  ReplSetWithCommandFailedEvent: require('./src/repl-set/ReplSetWithCommandFailedEvent'),
  ReplSetWithCommandStartedEvent: require('./src/repl-set/ReplSetWithCommandStartedEvent'),
  ReplSetWithCommandSucceededEvent: require('./src/repl-set/ReplSetWithCommandSucceededEvent'),
  ReplSetWithConnectEvent: require('./src/repl-set/ReplSetWithConnectEvent'),
  ReplSetWithErrorEvent: require('./src/repl-set/ReplSetWithErrorEvent'),
  ReplSetWithFullSetupEvent: require('./src/repl-set/ReplSetWithFullSetupEvent'),
  ReplSetWithHighAvailabilityEvent: require('./src/repl-set/ReplSetWithHighAvailabilityEvent'),
  ReplSetWithJoinedEvent: require('./src/repl-set/ReplSetWithJoinedEvent'),
  ReplSetWithLeftEvent: require('./src/repl-set/ReplSetWithJoinedEvent'),
  ReplSetWithOpenEvent: require('./src/repl-set/ReplSetWithOpenEvent'),
  ReplSetWithParseErrorEvent: require('./src/repl-set/ReplSetWithOpenEvent'),
  ReplSetWithTimeoutEvent: require('./src/repl-set/ReplSetWithTimeoutEvent'),
